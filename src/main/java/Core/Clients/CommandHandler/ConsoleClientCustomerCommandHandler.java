...
public class ConsoleClientCustomerCommandHandler {
    ...
    private void listCustomers() {
        ...
        for (int i = 0; i < customers.size(); i++) {
            System.out.println((i + 1) + ". " + ConsoleFormatter.formatCustomer(customers.get(i)));
        }
    }
    ...
    private void createCustomer() {
        ...
        try {
            LocalDate dateOfBirth = LocalDate.parse(dobStr, ConsoleFormatter.DATE_FORMATTER);
